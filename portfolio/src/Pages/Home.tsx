                ...
                <div className="col-md-4 ">
                  <div className="container d-flex justify-content-center align-items-start">
                    <img
                      src={multidevice}
                      className="circle"
                      style={{ width: "30%", height: "auto", maxWidth: "90px" }}
                    />
                  </div>
                </div>
                  ...
                  <div className="circular-container">
                    <div className="row d-flex justify-content-center align-items-center">
                      ...
                      <p
                        ...
                        style={{ fontSize: "12px" }}
                      >
                        Collaboration between clients and developers is crucial
                        for combining diverse expertise, fostering innovation,
                        and ensuring the final product is well-aligned with the
                ...
                >
                  <div className="container p-3 h-100 aboutmepara">
                    ...
                    <p className="about_para wrap">
                      ...
                      platforms. I am proficient in building applications using
                      a diverse range of programming languages including
                      Flutter, Java, Python, Kotlin, TypeScript, HTML, CSS, PHP,
                      SQL, MSSQL, and JavaScript.
                      <br />
                      <br />
